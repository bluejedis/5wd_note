以下是根据要求处理后的内容，包含挖空处理后的 Markdown 及 HTML 折叠块格式。
...
No additional content to fill in this section as per instruction to keep original structure intact.
...
$10/8\mathrm{Mb/s}=1.25\mathrm{Mb/s}$</li>
...
$10\mathrm{log}_{10}(S/N)=10\mathrm{log}_{10}100=20\mathrm{dB}$</li>
