...
- 1946（ENIAC）问世以来，计算机的发展已经经历了____代
  - 第一代计算机（1946-1957年）- ____管时代
    - 特点：
      - 逻辑元件采用____管
      - 使用____语言进行编程
      - 主存储器用延迟线或____存储信息，容量极小
      - 体积庞大，成本高
      - 运算速度较低，一般只有几千次到几万次每秒

  - 第二代计算机（1958-1964年）- ____管时代
    - 特点：
      - 逻辑元件采用____管
      - 运算速度提高到几万次到几十万次每秒
      - 主存储器使用____存储器
  ...
  - 第三代计算机（1965-1971年）- 中小规模____电路时代
    - 特点：
      - 逻辑元件采用中小规模____电路
      - ____存储器开始取代磁芯存储器
      - 高级语言发展迅速
      - 操作系统进一步发展，开始有____操作系统

  - 第四代计算机（1972年至今）- 超大规模____电路时代
    - 特点：
      - 逻辑元件采用大规模和超大规模____电路
      - 产生了____处理器
      - 应用新概念：
        - ____
        - ____线
...
- ____定律
  - 当价格不变时，集成电路上可容纳的晶体管数目约每隔____个月便会增加一倍
  - 性能也将提升____倍
  - 揭示了信息技术进步的____

- 半导体存储器的发展
  - 1970年，美国仙童半导体公司生产出第一个较大容量的____存储器
  - 经历了____代：
    - 单芯片1KB
    - 4KB
    - 16KB
...
- 微处理器的发展
  - 发展历程：
    ...
    - ____4（64位）
    - ____i7（64位）
  - 32位、64位指____字长，是指计算机进行一次整数运算所能处理的二进制数据的____数
