...
### 常见bus <span style="color: Gold;">标准</span>
...
### <span style="color: LightSkyBlue;">同</span>步<span style="color: Gold;">串</span><span style="color: green;">行</span>通信
- 特点
  - 发送方时钟直接控制接收方时钟
  - 双方完全同步的逐位传输
  - 仅在数据块头尾添加开始和结束标记
...
## <span style="color: green;">分离</span>式定时方式  
- 基本特征
