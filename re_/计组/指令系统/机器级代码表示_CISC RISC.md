# 程序' 机器级<span style="color: LightSkyBlue;">代码</span>表示  
...
- 统考大纲没有指定具体指令集
  - 历年统考真题主要考查的是x86汇编指令
  - 因此本节主要介绍x86汇编指令
## common<span style="color: green;">汇编</span><span style="color: LightSkyBlue;">指令</span>
<ul>

###  <span style="color: silver;">相关<span style="color: green;">R</span> 
